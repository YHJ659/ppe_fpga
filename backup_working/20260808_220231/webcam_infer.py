...
from sw.hybrid_pipeline import HybridPipeline, draw_detections
...
def main() -> None:
    ...
    parser.add_argument("--threads", type=int, default=0,
                        help="PyTorch intra-op threads; 0 keeps the runtime default")
    ...
    pipeline = HybridPipeline(
        ...
        conf=args.conf, threads=args.threads or None,

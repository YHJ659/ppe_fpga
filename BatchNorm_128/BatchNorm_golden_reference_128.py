...
save_dir = "BatchNorm_128/bn_silu_128cv1"
import os
os.makedirs(save_dir, exist_ok=True)

# ===== model.6.cv1 (C2f의 cv1, 1x1 Conv) 기준 =====
weight_tensor = model.model[6].cv1.conv.weight.detach()  # [128, 128, 1, 1]
bn = model.model[6].cv1.bn
...
input_tensor = captured_input['data'][0]  # [128, 40, 40]

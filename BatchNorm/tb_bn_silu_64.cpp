...
#define INPUT_SCALE   0.03178280357300766f
#define WEIGHT_SCALE  0.0029027743602362205f
#define OUTPUT_SCALE  0.01974109214121901f
...
int main() {
    ...
    bn_silu(conv_out, bn_scale, bn_shift, INPUT_SCALE, WEIGHT_SCALE, OUTPUT_SCALE, output);
